...
public class TestVod {
    ...
    public static void main(String[] args) {
        String accessKeyId = "LTAI4G9Adho2HYZYPj7z3p8M";
        String accessKeySecret = "6BKMxogpZGeLkRhKxrLhOL4eQsacDw";

        String title = "6 - What If I Want to Move Faster - upload by sdk";   //上传之后文件名称
        String fileName = "C:\\Users\\up\\Desktop\\pic\\测试.mp4";  //本地文件路径和名称
        //上传视频的方法
